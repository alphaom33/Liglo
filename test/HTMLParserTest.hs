...
tests = TestList $ [
        ...
        TestLabel "SelectTable" $ testMode [H.Table, H.Table, H.Select] H.InSelectInTable,
        TestLabel "SelectTemplate" $ testMode [H.Table, H.Table, H.Template, H.Select] H.InSelect,
        TestLabel "TDTrue" $ testMode [H.TestType, H.TD] H.InCell,
        TestLabel "THTrue" $ testMode [H.TestType, H.TH] H.InCell,
