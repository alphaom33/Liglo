...
characterReferences = Map.fromList [
    ...
    , ("NotElement;", '\x02209')
    , ("NotEqual;", '\x02260')
    , ("NotEqualTilde;", '\x02242')
    , ("NotExists;", '\x02204')
    , ("NotGreater;", '\x0226F')
    , ("NotGreaterEqual;", '\x02271')
    , ("NotGreaterFullEqual;", '\x02267')
    , ("NotGreaterGreater;", '\x0226B')
    , ("NotGreaterLess;", '\x02279')
    , ("NotGreaterSlantEqual;", '\x02A7E')
    , ("NotGreaterTilde;", '\x02275')
    , ("NotHumpDownHump;", '\x0224E')
    , ("NotHumpEqual;", '\x0224F')
    , ("notin;", '\x02209')
    , ("notindot;", '\x022F5')
    , ("notinE;", '\x022F9')
    ...
    , ("varsigma;", '\x003C2')
    , ("varsubsetneq;", '\x0228A')
    , ("varsubsetneqq;", '\x02ACB')
    , ("varsupsetneq;", '\x0228B')
    , ("varsupsetneqq;", '\x02ACC')
    , ("vartheta;", '\x003D1')
...
errToCodePoint :: Map.Map Integer Int
errToCodePoint = Map.fromList [
    (0x80, 0x20AC)
    , (0x82, 0x201A)
    , (0x83, 0x0192)
    , (0x84, 0x201E)
...
colorNameToColor :: Map.Map String (Int, Int, Int)
colorNameToColor = Map.fromList [
    ("black", (0, 0, 0))
    , ("silver", (192, 192, 192))
    , ("gray", (128, 128, 128))
    , ("white", (255, 255, 255))
